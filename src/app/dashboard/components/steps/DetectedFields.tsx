  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6">
      ...
      <div className="flex gap-2 sm:gap-4 flex-wrap justify-center w-full">
        <div className="px-3 sm:px-4 py-2 bg-[#E7FFEA] justify-center text-[#087025] flex-1 w-full rounded-sm font-medium flex items-center gap-2">
          <Search className="w-4 h-4" />
          {total} Fields Detected
        </div>
        <div className="px-3 sm:px-4 py-2 bg-[#F6F6FF] justify-center flex-1 w-full text-[#5740DF] rounded-sm font-medium flex items-center gap-2">
          <Target className="w-4 h-4" />
          {highConfidence} High Confidence
        </div>
        <div className="px-3 sm:px-4 py-2 bg-[#FFF1FC] justify-center flex-1 w-full text-[#B71897] rounded-sm font-medium flex items-center gap-2">
      ...
      <div className="flex flex-col gap-3 sm:gap-4 mt-2 sm:mt-4">
        {predictions?.map((p, index) => {
          ...
          return (
            <div
              key={index}
              className="flex flex-col p-3 sm:p-4 border rounded-lg bg-[#FDFDFD]"
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:gap-3 w-full">
                ...
                <div className="flex items-center gap-3">
                  <span
                    className={`px-2 py-1 text-xs sm:text-sm rounded-md font-medium ${confidenceColor}`}
                  >
                    {conf}%
                  </span>
                ...
                <div className="flex items-center gap-3 mt-2 md:mt-0 w-full md:w-auto">
                  ...
                  <p
                    className={`text-[14px] sm:text-[16px] font-medium truncate ${
